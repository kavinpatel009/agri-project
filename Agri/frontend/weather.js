document.addEventListener('DOMContentLoaded', function() {
    ...
    // API Key - In production, this should be secured in your backend
    const API_KEY ="becdeee2f5a145fc2c0fbda6cc31f594"; // Replace with your actual API key
    ...
    async function fetchWeather(location) {
        // In production, this should call your backend API which then calls OpenWeather
